...
void RccInit(void)
{
	//	RCC_DeInit();
		...
		if (HSEStartUpStatus == SUCCESS)
		{
			...
			RCC_PCLK1Config(RCC_HCLK_Div2);	/* PCLK1 = HCLK/2 */
			 ...
			 RCC_PLLConfig (RCC_PLLSource_HSE_Div1 , RCC_PLLMul_3);		// 3*8 = 24Mhz set PLL source clock and clock multiplier; PLLCLK = 8MHz * 9 = 72 MHz
	#else
			 RCC_PLLConfig (RCC_PLLSource_PREDIV1 , RCC_PLLMul_3);		//3*8 = 24Mhz set PLL source clock and clock multiplier; PLLCLK = 8MHz * 9 = 72 MHz
	#endif /* STM32F10X_CL */
	...
	#else
		  	SysTick_Config((72000000 / 1000) - 1);//SysTick_Config(12000);
	#endif /* STM32F10X_CL */
